...
public class MaintenanceAlertRepositoryAdapter implements MaintenanceAlertRepositoryPort {
    ...
    public MaintenanceAlert save(MaintenanceAlert alert) {
        MaintenanceAlertJpaEntity entity = MaintenanceAlertPersistenceMapper.toJpaEntity(alert);
        MaintenanceAlertJpaEntity saved = maintenanceAlertJpaRepository.save(entity);
        return MaintenanceAlertPersistenceMapper.toDomain(saved);
    }
